...
var W3 = [TE, UB, RS], WS3 = [0.4, 0.3, 0.3];
WScript.Echo("=== 3LEG(ETH-turtle 40/30/30) extreme weeks (fee 0.1%) ===");
function evt3(name, fromD, toD) {
  var r = comboRun(W3, WS3, 0.001, fromD, toD);
  ...
  WScript.Echo("  " + name + ": ret=" + (ret >= 0 ? "+" : "") + (ret * 100).toFixed(1) + "% intraDD=" + (dd * 100).toFixed(1) + "%");
}
evt3("FTX 2022-11     ", "2022-11-06", "2022-11-15");
evt3("squeeze 2024-03 ", "2024-02-28", "2024-03-20");
evt3("carry 2024-08   ", "2024-08-02", "2024-08-13");
evt3("2026-09 crash   ", "2026-09-10", "2026-09-16");
(function () {
  var r = comboRun(W3, WS3, 0.001, STARTC, null);
  var worst = [];
  for (var q2 = 7; q2 < r.curve.length; q2++) worst.push([r.curve[q2].eq / r.curve[q2 - 7].eq - 1, r.curve[q2].d]);
  worst.sort(function (a, b) { return a[0] - b[0]; });
  WScript.Echo("  worst-5 rolling 7d:");
...
(function () {
  ...
  WScript.Echo("  corr in FTX window: TE~UB=" + corrW(TE, UB, "2022-10-07", "2022-12-07").toFixed(2) + " TE~RS=" + corrW(TE, RS, "2022-10-07", "2022-12-07").toFixed(2) + " UB~RS=" + corrW(UB, RS, "2022-10-07", "2022-12-07").toFixed(2));
})();
